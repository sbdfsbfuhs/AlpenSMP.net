/* Gemeinsame Navigation auf Guide, Regeln, Rezensionen */
(function () {
  ...
  function activeKey() { if (p.indexOf("/guide") === 0) return "guide"; if (p.indexOf("/reviews") === 0) return "reviews"; return "regeln"; }
  function paintNav() {
