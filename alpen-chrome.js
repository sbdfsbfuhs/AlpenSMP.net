/* Gemeinsame öffentliche Navigation + Footer + Hero */
(function () {
  ...
  function activeKey() { if (path.indexOf("/guide") === 0) return "guide"; if (path.indexOf("/regeln") === 0) return "regeln"; return "home"; }
  function paintNav() {
